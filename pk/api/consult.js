...
const SYS = [
  ...
  'Промокоды на первый заказ: OZONBOT — минус 10% на Ozon, WBBOT10 — минус 10% на Wildberries. Называй их, если клиент спрашивает про скидку, цену, «как дешевле» или где выгоднее купить. Других промокодов и скидок не выдумывай.',
