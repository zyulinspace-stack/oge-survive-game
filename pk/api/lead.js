  ...
  return `<!doctype html><html><body style="margin:0;background:#f1f1f1;padding:24px 12px">
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;margin:0 auto;background:#fff;border-radius:10px;overflow:hidden">
      <tr><td style="background:#141414;padding:22px 24px;border-bottom:3px solid #ffcd00">
        <img src="https://primekraft.online/logo-mail.png" alt="PRIME KRAFT" width="170" style="display:block;width:170px;max-width:170px;height:auto;border:0;outline:none;text-decoration:none;font:900 italic 24px Arial Black,Arial,sans-serif;color:#ffffff">
        <div style="font:400 11px/1 Arial,sans-serif;color:#9aa0a8;margin-top:10px;letter-spacing:2px;text-transform:uppercase">Персональный подбор</div>
      </td></tr>
